        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                while (reader.Read())
                {
                    ...
                    var articlesContainer = (System.Web.UI.HtmlControls.HtmlGenericControl)this.FindControl("articles-container");

                    // Add the article element as a child of the articles container
                    articlesContainer.Controls.Add(article);
                }
            }
        }
    }
